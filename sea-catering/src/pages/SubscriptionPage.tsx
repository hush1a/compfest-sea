          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">Get dedicated customer support and priority access to new menu items and features.</p>
              </div>
              ...
              <div className="text-center p-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Flexible Changes</h3>
                <p className="text-gray-600">Easily modify, pause, or cancel your subscription anytime to fit your changing needs.</p>
              </div>
            </div>
          </div>
        </div>
